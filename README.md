...
Current test build: **v1.1.3b**. It adds a native persistent SM75 tensor-core
...
```
https://github.com/korjikkorjik/fff-miner/releases/download/v1.1.3b/fff-hiveos-v1.1.3b.tar.gz
```
...
rigs. The v1.1.3b Linux binary also passes the GPU/CPU proof self-test. If a
