...
- **[`hiveos/fff-1.1.3f.tar.gz`](hiveos/fff-1.1.3f.tar.gz)** — HiveOS custom miner package.

Current build: **v1.1.3f**. It adds a native persistent SM75 tensor-core
...
```
https://github.com/korjikkorjik/fff-miner/releases/download/v1.1.3f/fff-1.1.3f.tar.gz
```
...
rigs. The v1.1.3f Linux binary also passes the GPU/CPU proof self-test. If a
