...
- **[`hiveos/fff-1.1.1a.tar.gz`](hiveos/fff-1.1.1a.tar.gz)** — HiveOS custom miner package.

Current build: **v1.1.1a**. It adds a native persistent SM75 tensor-core
...
```
https://github.com/korjikkorjik/fff-miner/releases/download/v1.1.1a/fff-1.1.1a.tar.gz
```
...
rigs. The v1.1.1a Linux binary also passes the GPU/CPU proof self-test. If a
