...
HOW TO USE (HiveOS "Custom конфигурация" dialog)
  Имя майнера:                    fff
  Установочный URL:               https://github.com/korjikkorjik/fff-miner/releases/download/v1.1.3b/fff-hiveos-v1.1.3b.tar.gz
  ...
  Units (v1.1.3b): HiveOS's dashboard treats the "hs" array as plain kH/s
